...
void use_optiga_certificate(void)
{
    ...
    printf("  2) On the Certificates page, choose Create a certificate\n");
    printf("  3) Next to Use my certificate, choose Get started.\n");
    printf("  4) On the Select a CA page, leave this blank and choose Next. \n");
    printf("     Multi-Account Registration does not require the user to register \n");
    ...
    printf("     created, and then choose Attach.\n");
    printf("  8) You will need to attach your certificate to the Thing you created \n");
    printf("     earlier. On the Certificates page, choose the certificate \n");
    printf("     you just created.\n");
    printf("  9) Choose Actions and then Attach thing\n");
    printf("  10) Attach things to certificate(s) will pop up. \n");
    printf("     Choose the Thing name and select Attach.\n");
#if (MQTT_SECURE_CONNECTION)
